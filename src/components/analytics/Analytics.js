...
const Analytics = () => {
  ...
  useEffect(() => {
    ...
    axios
      .get(
        "http://benefits-dashboard-api-authenticated-dot-vaulted-bivouac-311707.wl.r.appspot.com/number_of_calls_complete/?start_date=02-15-2022&end_date=07-25-2023",
        {
          headers: {
            authToken:
  ...
  return (
    <div
      ...
      style={{ background: "#3e3b56", margin: "2vh", color: "#fff" }}
    >
